/**
 * Measures of similarity between two texts.
 *
 * Jaro, Jaro-Winkler and Levenshtein distance
 *
 * Jaro, Jaro Winkler:
 * The score is normalized such that 0 equates to no similarity   
 ...
 *
 */
	exports.jaroDistance=function(string1, string2) {
	...
	exports.jwDistance=function(string1,string2, leadingCharactersToScore, scorePerMatch) {
		...
		var jd = this.jaroDistance(string1,string2);
		var jw = jd+((leadingCharactersToScore*scorePerMatch)*(1-jd));
		return jw;	
	}
        
    exports.lsDistance=function(pattern, text) {
